import csv
f1=file('../data/userLiked_moviesID.csv','r')

actors_count=[]
for i in range(270):
    actors_count.append(0)
for row in csv.reader(f1):
    f2=file('../data/Hollywood_movie_calc.csv','r')
    for j in csv.reader(f2):
        try:
            ...
            pass
f4=file('../data/actors_count.csv','w')
l= len(actors_count)               
...
f1=file('../data/userLiked_moviesID.csv','r')
for row in csv.reader(f1):
    f2=file('../data/Bollywood_movie_calc.csv','r')
    for j in csv.reader(f2):
        try:
            if row[0]==j[0]:
                new_row=[]
            ...
            pass
f5=file('../data/genre_count.csv','w')
l= len(actors_count)               
#for i in actors_count:
 #   print i
for i in range(1,l):
